...
rnsKey  RnsShell::WindowX11::keyIdentifierForX11KeyCode(KeySym keycode){
    ...
    case XK_z: return RNS_KEY_z;
    /*Modifiers*/
    case XK_Caps_Lock: return RNS_KEY_CapsLock;
    case XK_Alt_L: return RNS_KEY_AltL;
    case XK_Alt_R: return RNS_KEY_AltR;
    case XK_Shift_L: return RNS_KEY_ShiftL;
    case XK_Shift_R: return RNS_KEY_ShiftR;
    case XK_Control_L: return RNS_KEY_ControlL;
    case XK_Control_R: return RNS_KEY_ControlR;
    /* Special char */
    case XK_Tab : return RNS_KEY_Tab;
    case XK_grave: return RNS_KEY_Backquote;
    case XK_asciitilde: return RNS_KEY_Tild;
    case XK_exclam: return RNS_KEY_exclam;
    case XK_at: return RNS_KEY_At;
    case XK_numbersign: return RNS_KEY_Hash;
    case XK_dollar: return RNS_KEY_Dolar;
    case XK_asciicircum: return RNS_KEY_Caret;
    case XK_ampersand: return RNS_KEY_Ampresend;
    case XK_asterisk: return RNS_KEY_Asterisk;
    case XK_parenleft: return RNS_KEY_LeftParaenthesis;
    case XK_parenright: return RNS_KEY_RightParenthesis;
    case XK_underscore: return RNS_KEY_Underscore;
    case XK_Delete: return RNS_KEY_Delete;
    case XK_KP_Page_Up: return RNS_KEY_PageUp;
    case XK_KP_Page_Down: return RNS_KEY_PageDown;
    ...
    case XK_apostrophe: return RNS_KEY_Quote;
    case XK_quotedbl: return RNS_KEY_DoubleQuote;
    case XK_colon: return RNS_KEY_Colon;
    case XK_semicolon: return RNS_KEY_Semicolon;
    case XK_bar: return RNS_KEY_Pipe;
    case XK_backslash : return RNS_KEY_BackSlash;
    case XK_braceleft: return RNS_KEY_OpenBace;
    case XK_braceright: return RNS_KEY_CloseBrace;
    ...
    case XK_plus: return RNS_KEY_Pluse;
    case XK_greater: return RNS_KEY_Grater;
    case XK_less: return RNS_KEY_Lesser;
