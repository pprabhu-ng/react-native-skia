...
rnsKey  RnsShell::WindowLibWPE::keyIdentifierForWPEKeyCode(int keyCode){
    ...
    case WPE_KEY_z: return RNS_KEY_z;
    /*Modifier keys */
    case WPE_KEY_Caps_Lock : return RNS_KEY_CapsLock;
    case WPE_KEY_Alt_L: return RNS_KEY_AltL;
    case WPE_KEY_Alt_R: return RNS_KEY_AltR;
    case WPE_KEY_Shift_L: return RNS_KEY_ShiftL;
    case WPE_KEY_Shift_R: return RNS_KEY_ShiftR;
    case WPE_KEY_Control_L: return RNS_KEY_ControlL;
    case WPE_KEY_Control_R: return RNS_KEY_ControlR;
    /*special case */
    case WPE_KEY_Tab: return RNS_KEY_Tab;
    case WPE_KEY_grave: return RNS_KEY_Backquote;
    case WPE_KEY_BackSpace: return RNS_KEY_Back;
    case WPE_KEY_asciitilde: return RNS_KEY_Tild;
    case WPE_KEY_exclam: return RNS_KEY_exclam;
    case WPE_KEY_at : return RNS_KEY_At;
    case WPE_KEY_numbersign: return RNS_KEY_Hash;
    case WPE_KEY_dollar: return RNS_KEY_Dolar;
    case WPE_KEY_asciicircum: return RNS_KEY_Caret;
    case WPE_KEY_ampersand: return RNS_KEY_Ampresend;
    case WPE_KEY_asterisk: return RNS_KEY_Asterisk;
    case WPE_KEY_braceleft: return RNS_KEY_OpenBace;
    case WPE_KEY_braceright: return RNS_KEY_CloseBrace;
    case WPE_KEY_underscore: return RNS_KEY_Underscore  ;
    case WPE_KEY_Delete: return RNS_KEY_Delete;
    //case WPE_KEY_KP_Enter : return RNS_KEY_Enter;
    case WPE_KEY_Page_Up: return RNS_KEY_PageUp;
    case WPE_KEY_Page_Down: return RNS_KEY_PageDown;
    ...
    case WPE_KEY_apostrophe: return RNS_KEY_Quote;
    case WPE_KEY_quotedbl: return RNS_KEY_DoubleQuote;
    case WPE_KEY_semicolon: return RNS_KEY_Semicolon;
    case WPE_KEY_colon: return RNS_KEY_Colon;
    case WPE_KEY_bar: return RNS_KEY_Pipe;
    case WPE_KEY_backslash: return RNS_KEY_BackSlash;
    case WPE_KEY_parenleft: return   RNS_KEY_LeftParaenthesis;
    case WPE_KEY_parenright: return RNS_KEY_RightParenthesis;
    ...
    case WPE_KEY_plus: return RNS_KEY_Pluse;
    case WPE_KEY_greater: return RNS_KEY_Grater;
    case WPE_KEY_less : return RNS_KEY_Lesser;
    /*UnKnownKey*/
