...
const ImageProps = (props) => {
  ...
  return(
    <View style={{justifyContent:'center', alignItems:'center', width:resolution.maincontainer.width, height:resolution.maincontainer.height}}> 
      <Image 
