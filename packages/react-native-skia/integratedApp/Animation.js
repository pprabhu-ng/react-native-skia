...
const Animation = props => {
  ...
  return(
    <View>
      <Animated.View style={[value.getLayout(), {backgroundColor: backgroundColor,width:fading, height:fading, borderWidth:20, borderRadius:25, borderColor:backgroundColor,
        shadowOffset: {
                width: 5,
                height: 15
              },
