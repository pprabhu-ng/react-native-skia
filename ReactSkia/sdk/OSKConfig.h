...
#define OSK_LIGHT_THEME_BG_COLOR              SkColorSetARGB(0xFF, 0x80, 0x80, 0x80) // Mild Dark Tone on SK_ColorGRAY
#define OSK_LIGHT_THEME_FONT_COLOR            SK_ColorWHITE
#define OSK_LIGHT_THEME_PH_COLOR              SkColorSetARGB(0xFF, 0x96, 0x96, 0x96) //Mild Lighter Tone on SK_ColorGRAY
...
#define OSK_HIGHLIGHT_BG_COLOR                SK_ColorWHITE
...
#define OSK_PH_NAME_VERTICAL_OFFSET           0.15
